Return-Path: <linux-man+bounces-1558-lists+linux-man=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-man@lfdr.de
Delivered-To: lists+linux-man@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 45CA6942C5A
	for <lists+linux-man@lfdr.de>; Wed, 31 Jul 2024 12:49:24 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 5C0251C20A23
	for <lists+linux-man@lfdr.de>; Wed, 31 Jul 2024 10:49:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7A9A51A7F79;
	Wed, 31 Jul 2024 10:49:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="DXrOpCvE"
X-Original-To: linux-man@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3A9D0190473
	for <linux-man@vger.kernel.org>; Wed, 31 Jul 2024 10:49:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1722422959; cv=none; b=DdungJ7K5O3Xqx8MxXZH2ucoVGjLtjkfGRBq00ERNF0z1U05GNf8utJfCxe1SlyyW9/QsLUnV8XPLp7yXiHrDnIgJiFTXd4Em0cRPXtALkfW4WBwPekpt8UghwLVwA3aSl7GP8vNTjYKe3DlGXYHx3F5DgapXgeqUTLSDhJC5Lo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1722422959; c=relaxed/simple;
	bh=h/5HeUHOqg9zdokq99rCM/yDwFt5P8kY3iqqp3DEEhY=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=gVAYZG1nn6z+vBBnFo/sQJW1RagljW42c1lPW6tNyiMcy0shDAU43cO2wf6hliN3f8HWyqTuSD7ZpSAp5hJT2t1DNIO4vQEvyh90gHIw0lbU2AqEdvU1j8uybgtmyWcocMYjYnurlv6/D9MYZsv/plMKL5Fa4Oi2eE7Ub+m7Zck=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=DXrOpCvE; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id F26FFC116B1;
	Wed, 31 Jul 2024 10:49:17 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1722422958;
	bh=h/5HeUHOqg9zdokq99rCM/yDwFt5P8kY3iqqp3DEEhY=;
	h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
	b=
Date: Wed, 31 Jul 2024 12:49:15 +0200
From: Alejandro Colomar <alx@kernel.org>
To: "G. Branden Robinson" <g.branden.robinson@gmail.com>
Cc: linux-man@vger.kernel.org
Subject: Re: [PATCH 3/3] man/man2/syscalls.2: srcfix (3/3)
Message-ID: <frqqvcige3wzkdoxog7knm4idqnzap7eivkwa5araky4zuhgys@iqnd2yhtsb57>
References: <20240727192802.gsdglp5n3mjdiren@illithid>
Precedence: bulk
...
Content-Type: multipart/signed; micalg=pgp-sha512;
	protocol="application/pgp-signature"; boundary="rkl2ljd3o7tlht7x"
Content-Disposition: inline
In-Reply-To: <20240727192802.gsdglp5n3mjdiren@illithid>
...
>=20
> troff:man/man2/syscalls.2:754: warning [page 2, line 26, diversion '3tbd1=
74,0', line 0]: cannot break line
>=20
...
>      block=E2=80=99s span, the default length of the text block (more pre=
cisely,
>      the line length used to process the text block=E2=80=99s diversion) =
is
...
>      block=E2=80=99s width by including an ll (line length) request in it=
 prior
...

=vMKI
-----END PGP SIGNATURE-----
