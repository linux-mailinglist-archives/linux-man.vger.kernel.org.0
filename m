Return-Path: <linux-man+bounces-5046-lists+linux-man=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-man@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id uwNTJhU2h2n9VAQAu9opvQ
	(envelope-from <linux-man+bounces-5046-lists+linux-man=lfdr.de@vger.kernel.org>)
	for <lists+linux-man@lfdr.de>; Sat, 07 Feb 2026 13:54:45 +0100
X-Original-To: lists+linux-man@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id B892A105E6D
	for <lists+linux-man@lfdr.de>; Sat, 07 Feb 2026 13:54:44 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id E64A83013B45
	for <lists+linux-man@lfdr.de>; Sat,  7 Feb 2026 12:54:42 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A11B533F8CF;
	Sat,  7 Feb 2026 12:54:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=nabijaczleweli.xyz header.i=@nabijaczleweli.xyz header.b="aex2p+ni"
X-Original-To: linux-man@vger.kernel.org
Received: from tarta.nabijaczleweli.xyz (tarta.nabijaczleweli.xyz [139.28.40.42])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CBA2419C566
	for <linux-man@vger.kernel.org>; Sat,  7 Feb 2026 12:54:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=139.28.40.42
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1770468879; cv=none; b=aWkVSSWnuA8Hpxr4QCigAHATLC/nW5cuVBA15ECdRy2choDF7+LOc4ivnEP3RLhEcsR6euDDktJ4HTPp5wRmnnJBYpHwRJfcQ4SjEsAPC2fdk5GrKfa+afeixAI0uQKZYf+4USlOSH8mDRciySTyXZhNHf6Z84QAv0MXWjPkfgk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1770468879; c=relaxed/simple;
	bh=Ed33KpSh4IVqkvY+9M2ETMYrY3s0VoCmMSOduDJ2moM=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type:
	 Content-Disposition; b=HowBFbOlNdiIj3zvoZ4+MFjxoKXnC7o+eTUUEOalv1OqdRd7lRaP4sUBVud1aM+sK7zSyzhtRmM001I52UC3YCrYQaP6bXHKelHXnqkNFv8AN4UnMxumtytoXddCP+ypGsspvMGDvh9j6sFx8y7Xuv5QXPVLH5Orep0xU69mOuI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=nabijaczleweli.xyz; spf=pass smtp.mailfrom=nabijaczleweli.xyz; dkim=pass (2048-bit key) header.d=nabijaczleweli.xyz header.i=@nabijaczleweli.xyz header.b=aex2p+ni; arc=none smtp.client-ip=139.28.40.42
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=nabijaczleweli.xyz
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=nabijaczleweli.xyz
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=nabijaczleweli.xyz;
	s=202505; t=1770468553;
	bh=Ed33KpSh4IVqkvY+9M2ETMYrY3s0VoCmMSOduDJ2moM=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from tarta.nabijaczleweli.xyz (unknown [192.168.1.250])
	by tarta.nabijaczleweli.xyz (Postfix) with ESMTPSA id 423561EE4;
	Sat,  7 Feb 2026 13:49:13 +0100 (CET)
Date: Sat, 7 Feb 2026 13:49:12 +0100
From: =?utf-8?B?0L3QsNCx?= <nabijaczleweli@nabijaczleweli.xyz>
To: Alejandro Colomar <alx@kernel.org>
Cc: linux-man@vger.kernel.org
Subject: [PATCH] futex_waitv.2: new page
Message-ID: <jpyv367v4jdxfxebxw6wh7rgqdfeswzp44dzsycfjt5k2pxe4j@tarta.nabijaczleweli.xyz>
Precedence: bulk
...
Content-Type: multipart/signed; micalg=pgp-sha512;
	protocol="application/pgp-signature"; boundary="llby7iz7tj6tugnv"
...
X-Spamd-Result: default: False [-4.26 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-5046-lists,linux-man=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	...
	TO_DN_SOME(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[tor.lore.kernel.org:helo,tor.lore.kernel.org:rdns,infradead.org:email,nabijaczleweli.xyz:email,nabijaczleweli.xyz:dkim]
X-Rspamd-Queue-Id: B892A105E6D
...
+.\"
+.\" FUTEX2_MPOL is not documented or used anywhere; it's unclear to me wha=
t it does
+.\" (defined in commit c042c505210dc3453f378df432c10fff3d471bc5 "futex: Im=
plement FUTEX2_MPOL")
+.TP
+.B FUTEX2_PRIVATE
...
+this flag waits on a private futex word, where all users must use the same=
 virtual memory map
...

=ePdf
-----END PGP SIGNATURE-----
