...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3655E69856B
	for <lists+linux-man@lfdr.de>; Wed, 15 Feb 2023 21:19:27 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229585AbjBOUT0 (ORCPT <rfc822;lists+linux-man@lfdr.de>);
        Wed, 15 Feb 2023 15:19:26 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42456 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229460AbjBOUTZ (ORCPT
        <rfc822;linux-man@vger.kernel.org>); Wed, 15 Feb 2023 15:19:25 -0500
Received: from omta002.cacentral1.a.cloudfilter.net (omta002.cacentral1.a.cloudfilter.net [3.97.99.33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B6BBB2D14D
        for <linux-man@vger.kernel.org>; Wed, 15 Feb 2023 12:19:23 -0800 (PST)
Received: from shw-obgw-4003a.ext.cloudfilter.net ([10.228.9.183])
        by cmsmtp with ESMTP
        id SJSnpB332l2xSSOFOp07z4; Wed, 15 Feb 2023 20:19:22 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=shaw.ca; s=s20180605;
        t=1676492362; bh=ZiLyE21iF0UwZjJgktVor4mTdNVD3RwPNu0R2w+OTTg=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References;
        b=
Received: from localhost.localdomain ([184.64.102.149])
        by cmsmtp with ESMTP
        id SOFOp9YWGcyvuSOFOp4Adw; Wed, 15 Feb 2023 20:19:22 +0000
X-Authority-Analysis: v=2.4 cv=VbHkgXl9 c=1 sm=1 tr=0 ts=63ed3e4a
 a=DxHlV3/gbUaP7LOF0QAmaA==:117 a=DxHlV3/gbUaP7LOF0QAmaA==:17 a=CCpqsmhAAAAA:8
 a=Bal4gtcBv142IzaLIqoA:9 a=hRrdT3L0C3MA:10 a=ul9cdbp4aOFLsgKbc677:22
From:   Brian Inglis <Brian.Inglis@Shaw.ca>
To:     "Linux Man Pages" <linux-man@vger.kernel.org>
Cc:     Alejandro Colomar <alx.manpages@gmail.com>
Subject: [PATCH v3 1/6] man2/: use IEC or ISO multiples to clarify long numeric digit strings
Date:   Wed, 15 Feb 2023 13:17:06 -0700
Message-Id: <4a3350ac873f45df96abf9045cfe1605839f490d.1676489381.git.Brian.Inglis@Shaw.ca>
X-Mailer: git-send-email 2.39.0
In-Reply-To: <cover.1676489380.git.Brian.Inglis@Shaw.ca>
References: <cover.1676489380.git.Brian.Inglis@Shaw.ca>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-CMAE-Envelope: 
