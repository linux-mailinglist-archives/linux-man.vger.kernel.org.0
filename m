Return-Path: <linux-man+bounces-618-lists+linux-man=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-man@lfdr.de
Delivered-To: lists+linux-man@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id E5F2187D766
	for <lists+linux-man@lfdr.de>; Sat, 16 Mar 2024 00:45:40 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 14C3B1C20E0C
	for <lists+linux-man@lfdr.de>; Fri, 15 Mar 2024 23:45:40 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 26B9C5A0E7;
	Fri, 15 Mar 2024 23:45:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="tUXbI7We"
X-Original-To: linux-man@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D9F0E59B72
	for <linux-man@vger.kernel.org>; Fri, 15 Mar 2024 23:45:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710546334; cv=none; b=kUdTn/nDxsIgumxugg2meMYfWt/S0Hb8prDb6TUIAbFOFGCdNgfnlnwog8EAxb63rg2wb0zTc262D42xQkm5F8Py+EK/9/uN7upCC4jHjGmsPzh3n56i0IFGXQBVJbSqsKnnHDBLs/QFLn722ZhF31hXDMesOxrS2h3FHhCMA+I=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710546334; c=relaxed/simple;
	bh=nfzzGiiZ8MKzKP8Olx1PLDUNO+sHjZKmbB5IZhCLTvU=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=aZnDy2OCBxDYQ5ei2a3osJP/2MqT5Zyq6O/VhNLb8hdOhztCPFWvT5ew2ghuiNb2c8IV/lYvFCI78iX4vJrH4q9C6STH6FKAmd08UKmq0wXnGkDWIUaVynnE7cZbgezv9qsLBZ15SVAsJWA/5t4qdV9Nl+nilYGlt8GcAXAY3KY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=tUXbI7We; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPSA id AAB33C433C7;
	Fri, 15 Mar 2024 23:45:33 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1710546334;
	bh=nfzzGiiZ8MKzKP8Olx1PLDUNO+sHjZKmbB5IZhCLTvU=;
	h=Date:From:To:Cc:Subject:References:In-Reply-To:From;
	b=
Date: Sat, 16 Mar 2024 00:45:31 +0100
From: Alejandro Colomar <alx@kernel.org>
To: Jeremy Baxter <jtbx@disroot.org>
Cc: linux-man@vger.kernel.org
Subject: Re: [PATCH] intro.1: Revise
Message-ID: <ZfTdm593ob_V1XhM@debian>
...
Content-Type: multipart/signed; micalg=pgp-sha512;
	protocol="application/pgp-signature"; boundary="6fEvL2OP0KsKttsY"
Content-Disposition: inline
In-Reply-To: <CZTT5VGOOCL4.2QQZNEEZ611D1@disroot.org>
...
> +which includes the owner of the file, its size, the date the file was la=
st
> +modified, as well as the permissions people have for reading and/or chan=
ging
> +the file. For example, the file "tel" here is 37 bytes long, owned by the
> +user aeb. The owner can read and write to it, but others can only read i=
t.
...
> +detail.
> +An introduction with more examples and explanations is useful for newcom=
ers.
...

=T47K
-----END PGP SIGNATURE-----
