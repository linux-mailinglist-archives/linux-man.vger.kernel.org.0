Return-Path: <linux-man+bounces-1736-lists+linux-man=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-man@lfdr.de
Delivered-To: lists+linux-man@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 8F2849672F7
	for <lists+linux-man@lfdr.de>; Sat, 31 Aug 2024 20:21:33 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 431E1283494
	for <lists+linux-man@lfdr.de>; Sat, 31 Aug 2024 18:21:32 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0A9DC13B29B;
	Sat, 31 Aug 2024 18:21:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="HkJaDSFi"
X-Original-To: linux-man@vger.kernel.org
Received: from mail-oa1-f47.google.com (mail-oa1-f47.google.com [209.85.160.47])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3AC8E23774
	for <linux-man@vger.kernel.org>; Sat, 31 Aug 2024 18:21:23 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.160.47
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1725128486; cv=none; b=dKw6fjkCb1HPGomnAKzdKpxID+Xf45F6mudEeySWtKMoiy9B1UT0cwk+XKWGLCnHgVa3M5kcDN+bMZPSY4XiD4C22sTan+FMkDZQx1LxQAZpY2YXsRHr/wUZyJxRSXxUSebiMGrhYvcsW3kFvwqc6nIiOZ4sovGDPnrkFdO838I=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1725128486; c=relaxed/simple;
	bh=11Q+sbP6bCYg/tX7/6nkm+7BrtxiyXq2oAF2nPwZ0Ow=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type:
	 Content-Disposition; b=OXm2ZnrpKQbp2RS1vVh3updGD0AFHBjqBZoQUIrb4lmmxwl15sNqruZ0Nwas+26Rpxngb0Idq7zCwLfuTXXdXiq1aPQE7ucVvJdVz07wYVX+/4WAJ6yhp0PawmRmiPWK4TXnoM5ADO5mtD0Yk3PJ/BQSz3lm/vZjbQy8sq2C32w=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=HkJaDSFi; arc=none smtp.client-ip=209.85.160.47
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-oa1-f47.google.com with SMTP id 586e51a60fabf-273cf9bbb3eso1624541fac.1
        for <linux-man@vger.kernel.org>; Sat, 31 Aug 2024 11:21:23 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1725128482; x=1725733282; darn=vger.kernel.org;
        h=content-disposition:mime-version:message-id:subject:cc:to:from:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=jhFcrV9uaTfsLoPXeqhS2BXQxazWpNe8qEJJ9YN0K1Q=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1725128482; x=1725733282;
        h=content-disposition:mime-version:message-id:subject:cc:to:from:date
         :x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=jhFcrV9uaTfsLoPXeqhS2BXQxazWpNe8qEJJ9YN0K1Q=;
        b=
X-Gm-Message-State: AOJu0Yy6m9NY4vcoQRyimX7IefdMkTkffAM+e1hTc0l0+3u7Fw9HyFqY
	7vu9mNNTFUaU0fCtfsdHf0ekpl+KXhfgFjTMn+PE0Fcc7CKCvgfDngs+Xw==
X-Google-Smtp-Source: AGHT+IF+J5kAp1DmbH6gcO/WWkIpvZsaB1NYT+EwoLW9W2oI+DwxuxuOJdtC3yosIGyx/37sCs2SAw==
X-Received: by 2002:a05:6870:56a8:b0:270:46be:9534 with SMTP id 586e51a60fabf-277ccc10335mr3025065fac.24.1725128481496;
        Sat, 31 Aug 2024 11:21:21 -0700 (PDT)
Received: from illithid ([2600:1700:957d:1d70::49])
        by smtp.gmail.com with ESMTPSA id 586e51a60fabf-277abace54bsm1318025fac.5.2024.08.31.11.21.20
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sat, 31 Aug 2024 11:21:20 -0700 (PDT)
Date: Sat, 31 Aug 2024 13:21:19 -0500
From: "G. Branden Robinson" <g.branden.robinson@gmail.com>
To: Alejandro Colomar <alx@kernel.org>
Cc: linux-man@vger.kernel.org
Subject: [PATCH 4/5] man/: srcfix
Message-ID: <20240831182119.wifbdbligob6h3fg@illithid>
Precedence: bulk
...
Content-Type: multipart/signed; micalg=pgp-sha256;
	protocol="application/pgp-signature"; boundary="xpupcaxcyhvmyhzh"
...
sh dump-page.sh $pages > pages.txt.0
sed -i -f fix-man-page-refs-in-tbl-tables-3.sed $pages
sh dump-page.sh $pages > pages.txt.3
cmp pages.txt.[03] && echo SAME
...
[[[
Why "3" instead of "1"?  Because I had other sed scripts that did other
preparation, and from which previous commits arose on 27 July, but they
are no-ops when re-run.

The _full_ procedure actually looked like this.

$ cat MR-migrate-stage-1-prepare.sh
...
sh dump-page.sh $pages > pages.txt.0
sed -i -f fix-man-page-refs-in-tbl-tables-1.sed $pages
sh dump-page.sh $pages > pages.txt.1
cmp pages.txt.[01] && echo SAME
if ! git diff --exit-code
then
	read -p '(1/3) commit? ' x
	git commit -v $pages
fi
sed -i -f fix-man-page-refs-in-tbl-tables-2.sed $pages
sh dump-page.sh $pages > pages.txt.2
cmp pages.txt.[12] && echo SAME
if ! git diff --exit-code
then
	read -p '(2/3) commit? ' x
	git commit -v $pages
...
---
 ...
 5 files changed, 1748 insertions(+), 660 deletions(-)
...
index cf3436f09..c0d705ffb 100644
--- a/man/man7/namespaces.7
+++ b/man/man7/namespaces.7
@@ -33,27 +33,43 @@ .SS Namespace types
 lB lB lB      lB
 l  lB lw(21n) lx.
...
index 657f82cde..31eeabc7b 100644
--- a/man/man7/suffixes.7
+++ b/man/man7/suffixes.7
@@ -41,7 +41,10 @@ .SH DESCRIPTION
...

=xXaA
-----END PGP SIGNATURE-----
