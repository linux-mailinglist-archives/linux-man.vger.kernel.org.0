...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 83A65624E7A
	for <lists+linux-man@lfdr.de>; Fri, 11 Nov 2022 00:32:29 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229559AbiKJXc1 (ORCPT <rfc822;lists+linux-man@lfdr.de>);
        Thu, 10 Nov 2022 18:32:27 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35732 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229703AbiKJXc0 (ORCPT
        <rfc822;linux-man@vger.kernel.org>); Thu, 10 Nov 2022 18:32:26 -0500
Received: from mu.digital-domain.net (mu.digital-domain.net [IPv6:2001:19f0:7402:15d6:5400:3ff:feab:f47a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DA615528A1
        for <linux-man@vger.kernel.org>; Thu, 10 Nov 2022 15:32:23 -0800 (PST)
Received: from kappa.digital-domain.net (kappa.digital-domain.net [IPv6:2001:8b0:36c:cc91:0:0:0:ac])
        (authenticated bits=0)
        by mu.digital-domain.net (8.17.1/8.17.1) with ESMTPSA id 2AANW1ZP060564
        (version=TLSv1.3 cipher=TLS_AES_256_GCM_SHA384 bits=256 verify=NOT);
        Thu, 10 Nov 2022 23:32:11 GMT
DKIM-Filter: OpenDKIM Filter v2.11.0 mu.digital-domain.net 2AANW1ZP060564
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=digital-domain.net;
        s=dkim-1; t=1668123131;
        bh=lxXD4uOIS907jO7EGGP0JFxyEgcZ1hdJtzJ9XogiDXM=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [PATCH v2] memmem.3: Add list of known systems where this is available
Date:   Thu, 10 Nov 2022 23:31:38 +0000
Message-Id: <20221110233138.63585-1-andrew@digital-domain.net>
