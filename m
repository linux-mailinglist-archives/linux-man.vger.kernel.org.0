...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E3B032B393C
	for <lists+linux-man@lfdr.de>; Sun, 15 Nov 2020 21:47:34 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727928AbgKOUrH (ORCPT <rfc822;lists+linux-man@lfdr.de>);
        Sun, 15 Nov 2020 15:47:07 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50958 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727656AbgKOUrH (ORCPT
        <rfc822;linux-man@vger.kernel.org>); Sun, 15 Nov 2020 15:47:07 -0500
Received: from mail-wm1-x341.google.com (mail-wm1-x341.google.com [IPv6:2a00:1450:4864:20::341])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CD43FC0613CF
        for <linux-man@vger.kernel.org>; Sun, 15 Nov 2020 12:47:06 -0800 (PST)
Received: by mail-wm1-x341.google.com with SMTP id 23so10908351wmg.1
        for <linux-man@vger.kernel.org>; Sun, 15 Nov 2020 12:47:06 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=cc:subject:to:references:from:message-id:date:user-agent
         :mime-version:in-reply-to:content-language:content-transfer-encoding;
        bh=gH4s620xWTtvEBEybJ83igWrunDjxUlnuAYXe82VyQU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=gH4s620xWTtvEBEybJ83igWrunDjxUlnuAYXe82VyQU=;
        b=
X-Gm-Message-State: AOAM531ETJ/KjK4aDziTkBaB2LAkGulhnOBJCyRzwD8NK77GWbyDB1or
        LL+1Sk2pLSsq+vufHoUCw2Q9uGez75idsQ==
X-Google-Smtp-Source: ABdhPJyyDtobPFygWDS1Y2Uxb09Nleh4rrBNTFRAHVFyalA5HmXEfHUPh9YqdXkQb1DRoVxkarWdCw==
X-Received: by 2002:a1c:b387:: with SMTP id c129mr12742907wmf.66.1605473224033;
        Sun, 15 Nov 2020 12:47:04 -0800 (PST)
Received: from ?IPv6:2001:a61:24b3:de01:7310:e730:497d:ea6a? ([2001:a61:24b3:de01:7310:e730:497d:ea6a])
        by smtp.gmail.com with ESMTPSA id x12sm13024368wrt.18.2020.11.15.12.47.03
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Sun, 15 Nov 2020 12:47:03 -0800 (PST)
Cc:     mtk.manpages@gmail.com,
        Alejandro Colomar <colomar.6.4.3@gmail.com>,
        linux-man@vger.kernel.org
Subject: Re: [PATCH] getent.1, fanotify_mark.2, fcntl.2, futex.2,
 membarrier.2, mmap.2, mount.2, msgctl.2, readv.2, semctl.2, set_mempolicy.2,
 shmctl.2, syscalls.2, abs.3, bstring.3, btree.3, ctime.3, drand48.3, fgetc.3,
 fopen.3, gethostbyname.3, getnetent.3, getprotoent.3, getservent.3,
 INFINITY.3, __ppc_set_ppr_med.3, inet.3, j0.3, makecontext.3, printf.3,
 puts.3, resolver.3, sigsetops.3, elf.5, nscd.conf.5, proc.5, inotify.7,
 ipv6.7, spufs.7, system_data_types.7: Use Oxford comma
To:     Alejandro Colomar <alx.manpages@gmail.com>
References: <20201115123230.108989-1-colomar.6.4.3@gmail.com>
From:   "Michael Kerrisk (man-pages)" <mtk.manpages@gmail.com>
Message-ID: <c40bf8ff-3626-7002-e8bc-0d8d6bf1612b@gmail.com>
Date:   Sun, 15 Nov 2020 21:47:02 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:78.0) Gecko/20100101
 Thunderbird/78.3.1
MIME-Version: 1.0
In-Reply-To: <20201115123230.108989-1-colomar.6.4.3@gmail.com>
