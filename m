...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C07D2754CE6
	for <lists+linux-man@lfdr.de>; Sun, 16 Jul 2023 02:35:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229574AbjGPAfx (ORCPT <rfc822;lists+linux-man@lfdr.de>);
        Sat, 15 Jul 2023 20:35:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41614 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229563AbjGPAfw (ORCPT
        <rfc822;linux-man@vger.kernel.org>); Sat, 15 Jul 2023 20:35:52 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2B7082715
        for <linux-man@vger.kernel.org>; Sat, 15 Jul 2023 17:35:50 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (2048 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 364AD60BA7
        for <linux-man@vger.kernel.org>; Sun, 16 Jul 2023 00:35:50 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id 0AB68C433C7;
        Sun, 16 Jul 2023 00:35:46 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1689467749;
        bh=RALKl26aXeeMxxt29rxx7+vTGUjnDRORHDsw7HBk/0w=;
        h=Date:Subject:To:Cc:References:From:In-Reply-To:From;
        b=
Message-ID: <ff17c973-56d0-8cf9-80c2-301ff57b7563@kernel.org>
...
Content-Type: multipart/signed; micalg=pgp-sha256;
 ...
 boundary="------------cDhh1he4UHykcENkG00Yv42Q"
...
--------------cDhh1he4UHykcENkG00Yv42Q
Content-Type: multipart/mixed; boundary="------------9psLgZixjx5v1i8wNmP121Y0";
...
Cc: Paul Eggert <eggert@cs.ucla.edu>, Sam James <sam@gentoo.org>,
 ...
 Szabolcs Nagy <nsz@port70.net>, Jakub Wilk <jwilk@jwilk.net>,
 GNU C Library <libc-alpha@sourceware.org>, enh <enh@google.com>
Message-ID: <ff17c973-56d0-8cf9-80c2-301ff57b7563@kernel.org>
Subject: Re: [musl] Re: [libc-coord] [PATCH v4] off64_t: prefer off_t for
 splice, etc.
References: <78b648da-dde7-d331-7384-03214b977e6d@kernel.org>
...
>>     Fixes: 76c5631fb442 ("copy_file_range.2: Document glibc wrapper in=
stead of kernel syscall")
>>     Fixes: 5cabfa06b407 ("man-pages 1.68")
>>     Fixes: 3ca974e3988a ("New page for sync_file_range(2), new in kern=
el 2.6.17.")
>>     Fixes: 9bebb17e5b57 ("sync_file_range.2: Document the architecture=
-specific sync_file_range2() system call")
...

=ubG8
-----END PGP SIGNATURE-----
