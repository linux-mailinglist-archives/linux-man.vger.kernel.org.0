Return-Path: <linux-man+bounces-5054-lists+linux-man=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-man@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id feuTIE1uiGnHpQQAu9opvQ
	(envelope-from <linux-man+bounces-5054-lists+linux-man=lfdr.de@vger.kernel.org>)
	for <lists+linux-man@lfdr.de>; Sun, 08 Feb 2026 12:06:53 +0100
X-Original-To: lists+linux-man@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id C7CC41087A3
	for <lists+linux-man@lfdr.de>; Sun, 08 Feb 2026 12:06:52 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id D1348306F940
	for <lists+linux-man@lfdr.de>; Sun,  8 Feb 2026 11:02:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6B205314D2A;
	Sun,  8 Feb 2026 11:02:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="KeufXENa"
X-Original-To: linux-man@vger.kernel.org
Received: from mail-yw1-f182.google.com (mail-yw1-f182.google.com [209.85.128.182])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D1ECB2BD59C
	for <linux-man@vger.kernel.org>; Sun,  8 Feb 2026 11:02:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.128.182
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1770548555; cv=none; b=cqcaJIDCXJJuX/0vUcRNgn1bcjfQGQFmRLeXv7CbG0EyLJgyJdA+alqg1Bt+ooSbnRThB/sl/j0FVSYdfZYJSqY3e3bPrUK7uyc0+NaIaIaBP4mQvHS6InV4AubSKLLMuFlU0wId7Bd6XI6cabpaRB499MWIl9FQgX9M32Sb85w=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1770548555; c=relaxed/simple;
	bh=pP7+AT07PBXyDyy0NS4EVvYEsN0dB0cUAOB10jhAyHo=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type:
	 Content-Disposition; b=KCJ04Ma/qiksGvLMlgFc2Fet51yEoit36DoDnTVFqV6fXxRsgy+9DJ2bD95/3kAK1kt1zA5RioLp6Lw13u82rJ8uSzzphgYCN3JyOFIZ3RKGBAPQ5007tUo0mR1KqKo91WPS3l2jcBGUOd6QrwUBMbRgXh2rxtwhn/VWp4lvvd4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=KeufXENa; arc=none smtp.client-ip=209.85.128.182
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-yw1-f182.google.com with SMTP id 00721157ae682-793fdbb8d3aso34115747b3.3
        for <linux-man@vger.kernel.org>; Sun, 08 Feb 2026 03:02:34 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1770548554; x=1771153354; darn=vger.kernel.org;
        h=content-disposition:mime-version:message-id:subject:cc:to:from:date
         :from:to:cc:subject:date:message-id:reply-to;
        bh=2qF1YZqBuUYoixU3T1eIK04WHadxcia2DAYnkkdWhkU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1770548554; x=1771153354;
        h=content-disposition:mime-version:message-id:subject:cc:to:from:date
         :x-gm-gg:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=2qF1YZqBuUYoixU3T1eIK04WHadxcia2DAYnkkdWhkU=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCUv4IbCoBupjOHE+lur6iO0yid3aBE2XiTfAFcQdbfZPajWmSj53gYTC/yuBIxsaYqeCVkma6BsgD0=@vger.kernel.org
X-Gm-Message-State: AOJu0YyEH4tba79aphmQdsZ3Y6bfy/J+b3iP/EHILXFTCeRpZyiNW6HZ
	2kJxcaIPnqcAJ23D+2b+T4ZK2NH9TQRVge2eKbwetI6+P4wFu1NeLudh
X-Gm-Gg: 
	N4
X-Received: by 2002:a05:690c:fc6:b0:794:7448:5fc8 with SMTP id 00721157ae682-7952ab38c0amr83465227b3.45.1770548552774;
        Sun, 08 Feb 2026 03:02:32 -0800 (PST)
Received: from illithid ([2600:1702:7cd0:e980::48])
        by smtp.gmail.com with ESMTPSA id 00721157ae682-7952a013704sm66154007b3.11.2026.02.08.03.02.31
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 08 Feb 2026 03:02:31 -0800 (PST)
Date: Sun, 8 Feb 2026 05:02:29 -0600
From: "G. Branden Robinson" <g.branden.robinson@gmail.com>
To: info-groff@gnu.org, platform-testers@gnu.org
Cc: groff@gnu.org, linux-man@vger.kernel.org
Subject: groff 1.24.0.rc3 available for evaluation
Message-ID: <20260208110229.ximueomm2xbgyfki@illithid>
Precedence: bulk
...
Content-Type: multipart/signed; micalg=pgp-sha256;
	protocol="application/pgp-signature"; boundary="tcwcwx33dc3sbxc2"
...
X-Spamd-Result: default: False [-3.76 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-5054-lists,linux-man=lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[gnu.org:url,nongnu.org:url,tor.lore.kernel.org:helo,tor.lore.kernel.org:rdns]
X-Rspamd-Queue-Id: C7CC41087A3
...
groff 1.24.0 release candidate 3, 1.24.0.rc3, is now available from
...
Since groff 1.24.0.rc2 was made available on 26 January, 4 people have
authored a total of 102 commits.

$ git shortlog --summary 1.24.0.rc2..1.24.0.rc3
     2  Dariusz Chilimoniuk
     1  Deri James
    97  G. Branden Robinson
     2  Peter Schaffter

Thanks to Bruno Haible, Alexis Hildebrandt, Morten Bo Johansen, Deri
James, and Ingo Schwarze for reporting defects in rc2.  Gavin Smith also
pointed out a stale URL in our grotty(1) man page.  This release
candidate should resolve those defects, with one known exception (see
below).

*  Dariusz Chilimoniuk contributed a Polish language localization.

*  A change to the gropdf output driver to support the same "generic"
   CJK typefaces as the grohtml, gropdf, and grotty output drivers has
   been reverted; it is thought unnecessary.

*  An input-processing defect in troff, the formatter, was resolved.
   (Savannah #68026).

*  Spurious test failures on OpenBSD and NetBSD have been corrected.

*  We've updated the "gnulib" submodule to refresh the "stable/2026-01"
   branch to capture a fix for compiling C++ on FreeBSD 15.

*  The configuration summary produced at or near the end of the
   "configure" script's operation now identifies itself and has been
   reorganized to better report the status of Ghostscript and URW font
   support, and the feature support level of the gropdf output driver
   that they enable.

*  A bug in an Autoconf macro that broke the "--with-urw-fonts-dir"
   option to our "configure" script has been fixed.

*  An assertion failure in troff, the formatter, that trips in unusual
   circumstances, has been fixed (Savannah #67990).

*  The set of PDF documents the groff build generates is no longer
   dependent on the feature support level of the gropdf output driver.
   (There can be cosmetic differences in the generated documents,
   however.)

*  The gropdf output driver no longer creates a directory named
   "_Inline" in the user's home directory.

*  An error diagnostic issued by troff, the formatter, that was prone to
   trip many times when encountering old-fashioned input intended for
   AT&T troff, has been re-demoted to a warning in category "tab",
   consistently with groff 1.23.0 (Savannah #68017).

*  The behavior of the tbl preprocessor's "center" region option, and a
   related diagnostic message, have been clarified.

*  A new command-line option to the gropdf output driver has been
   renamed to `--format-options`, and now has a `-f` short option
   synonym.
...
a total of over 5,100 commits.

$ git shortlog --summary 1.23.0..1.24.0.rc3
...
project has resolved 369 issues as fixed for the 1.24.0 release.

Another way of capturing the amount of revision is as follows.

$ git diff --stat 1.23.0 1.24.0.rc3 | tail -n 1
 1207 files changed, 156454 insertions(+), 83519 deletions(-)
...
Here are the compressed sources and a GPG detached signature[*].
  https://alpha.gnu.org/gnu/groff/groff-1.24.0.rc3.tar.gz
  https://alpha.gnu.org/gnu/groff/groff-1.24.0.rc3.tar.gz.sig

Here are the SHA-1 and SHA-256 checksums.

ad34f2f28bade1462edcdb8756612690fefcf2f5  groff-1.24.0.rc3.tar.gz
+lIE3OPVMwecQNyqEYO+ByIl8XRuAYnJfVVTrdewjVA=3D  groff-1.24.0.rc3.tar.gz
...
sha256sum < groff-1.24.0.rc3.tar.gz | cut -f1 -d\  | xxd -r -p | base64
...
[*] Use a .sig file to verify that the corresponding file (without the
    ...
    file and the corresponding archive.  Then, verify the archive.
      ...
      gpg --verify groff-1.24.0.rc3.tar.gz{.sig,}
...

=/Pfa
-----END PGP SIGNATURE-----
