...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A298B5B3236
	for <lists+linux-man@lfdr.de>; Fri,  9 Sep 2022 10:49:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231837AbiIIIql (ORCPT <rfc822;lists+linux-man@lfdr.de>);
        Fri, 9 Sep 2022 04:46:41 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44774 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231829AbiIIIqV (ORCPT
        <rfc822;linux-man@vger.kernel.org>); Fri, 9 Sep 2022 04:46:21 -0400
Received: from smtp-out1.suse.de (smtp-out1.suse.de [195.135.220.28])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8FF3412F233
        for <linux-man@vger.kernel.org>; Fri,  9 Sep 2022 01:46:20 -0700 (PDT)
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
        (No client certificate requested)
        by smtp-out1.suse.de (Postfix) with ESMTPS id 833B422919;
        Fri,  9 Sep 2022 08:46:18 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=suse.cz; s=susede2_rsa;
        t=1662713178;
        h=from:from:reply-to:reply-to:date:date:message-id:message-id:to:to:
         cc:cc:mime-version:mime-version:content-type:content-type:
         in-reply-to:in-reply-to:references:references;
        bh=7bwu90PHa6gTJIZsSNZNj3Ydq0/U4E+mHUQFwmfHefw=;
        b=Unabrp2ChITW8dcdau3W/37K51Fjg1iIELOVp8d+k0F7Sw1jzv92XflLCB/VLrUgBGuz5i
        0Cx61DbYmJ/U91DiyikeTvgBHkgTBnpDd0j2+laonfAE+IAUZxWdvfoOsBPEj7sES5uCdK
        OmfTFPXcUXdC5p9vFpNJQCBbFypojkc=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.cz;
        s=susede2_ed25519; t=1662713178;
        h=from:from:reply-to:reply-to:date:date:message-id:message-id:to:to:
         cc:cc:mime-version:mime-version:content-type:content-type:
         in-reply-to:in-reply-to:references:references;
        bh=7bwu90PHa6gTJIZsSNZNj3Ydq0/U4E+mHUQFwmfHefw=;
        b=p/by2ffG9pzxyorfF749glj20wQqb92NnpZH0CrBNjzEj+EOT8wmLCaUy3vT7rFlyWqvCW
        9jBLFOoS2trcFMCQ==
Received: from imap2.suse-dmz.suse.de (imap2.suse-dmz.suse.de [192.168.254.74])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature ECDSA (P-521) server-digest SHA512)
        (No client certificate requested)
        by imap2.suse-dmz.suse.de (Postfix) with ESMTPS id 4EDEA139D5;
        Fri,  9 Sep 2022 08:46:18 +0000 (UTC)
Received: from dovecot-director2.suse.de ([192.168.254.65])
        by imap2.suse-dmz.suse.de with ESMTPSA
        id dyavEVr9GmNHTwAAMHmgww
        (envelope-from <pvorel@suse.cz>); Fri, 09 Sep 2022 08:46:18 +0000
Date:   Fri, 9 Sep 2022 10:46:16 +0200
...
Message-ID: <Yxr9WN7f3FEqKVRg@pevik>
