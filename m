...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C629368B44F
	for <lists+linux-man@lfdr.de>; Mon,  6 Feb 2023 04:04:48 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229489AbjBFDEs (ORCPT <rfc822;lists+linux-man@lfdr.de>);
        Sun, 5 Feb 2023 22:04:48 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60722 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229447AbjBFDEr (ORCPT
        <rfc822;linux-man@vger.kernel.org>); Sun, 5 Feb 2023 22:04:47 -0500
Received: from omta001.cacentral1.a.cloudfilter.net (omta001.cacentral1.a.cloudfilter.net [3.97.99.32])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2941D9771
        for <linux-man@vger.kernel.org>; Sun,  5 Feb 2023 19:04:45 -0800 (PST)
Received: from shw-obgw-4001a.ext.cloudfilter.net ([10.228.9.142])
        by cmsmtp with ESMTP
        id OjrMpmWXfc9C4OroCpSCOO; Mon, 06 Feb 2023 03:04:44 +0000
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=shaw.ca; s=s20180605;
        t=1675652684; bh=UFRiC4QTAL842XWjQou4/2j5/D75MoL0D0deYqQTu0o=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References;
        b=
Received: from localhost.localdomain ([184.64.124.72])
        by cmsmtp with ESMTP
        id Oro7pVOibHFsOOroBp3dsN; Mon, 06 Feb 2023 03:04:44 +0000
X-Authority-Analysis: v=2.4 cv=XZqaca15 c=1 sm=1 tr=0 ts=63e06e4c
...
Subject: [PATCH 11/11] man2/: punctuate long numeric strings with digit separators
Date:   Sun,  5 Feb 2023 20:04:27 -0700
Message-Id: <20230206030427.35002-2-Brian.Inglis@Shaw.ca>
X-Mailer: git-send-email 2.39.0
In-Reply-To: <20230206030427.35002-1-Brian.Inglis@Shaw.ca>
References: <20230206030427.35002-1-Brian.Inglis@Shaw.ca>
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="------------2.39.0"
Content-Transfer-Encoding: 8bit
X-CMAE-Envelope: 
X-Spam-Status: No, score=-2.8 required=5.0 tests=BAYES_00,DKIM_SIGNED,
        DKIM_VALID,DKIM_VALID_AU,DKIM_VALID_EF,RCVD_IN_DNSWL_LOW,
        RCVD_IN_MSPIKE_H2,SPF_HELO_NONE,SPF_PASS,WEIRD_QUOTING autolearn=ham
...
--------------2.39.0
Content-Type: text/x-patch; name="0011-man2-punctuate-long-numeric-strings-with-digit-separ.patch"
Content-Transfer-Encoding: 8bit
Content-Disposition: attachment; filename="0011-man2-punctuate-long-numeric-strings-with-digit-separ.patch"
